          ...
          <Animated.View entering={FadeIn.duration(200)} exiting={FadeOut}>
            <TextClassContext.Provider value="text-popover-foreground">
              <PopoverPrimitive.Content
                ...
                className={cn(
                  "web:data-[side=bottom]:slide-in-from-top-2 web:data-[side=left]:slide-in-from-right-2 web:data-[side=right]:slide-in-from-left-2 web:data-[side=top]:slide-in-from-bottom-2 web:zoom-in-95 web:fade-in-0 z-50 w-72 rounded-md border border-border bg-popover p-4 shadow-foreground/5 shadow-md web:animate-in web:cursor-auto web:outline-none",
                  className,
                )}
                {...props}
              />
