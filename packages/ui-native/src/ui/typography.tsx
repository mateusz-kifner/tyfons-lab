  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="1"
        className={cn(
          "font-extrabold text-4xl text-foreground tracking-tight web:select-text web:scroll-m-20 lg:text-5xl",
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="2"
        className={cn(
          "border-border border-b pb-2 font-semibold text-3xl text-foreground tracking-tight first:mt-0 web:select-text web:scroll-m-20",
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="3"
        className={cn(
          "font-semibold text-2xl text-foreground tracking-tight web:select-text web:scroll-m-20",
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="4"
        className={cn(
          "font-semibold text-foreground text-xl tracking-tight web:select-text web:scroll-m-20",
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          "relative rounded-md bg-muted px-[0.3rem] py-[0.2rem] font-semibold text-foreground text-sm web:select-text",
          className,
        )}
        ref={ref}
        {...props}
...
const Large = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn(
          "font-semibold text-foreground text-xl web:select-text",
          className,
        )}
        ref={ref}
        {...props}
...
const Small = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn(
          "font-medium text-foreground text-sm leading-none web:select-text",
          className,
        )}
        ref={ref}
        {...props}
