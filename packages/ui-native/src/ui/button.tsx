...
const buttonVariants = cva(
  "group flex items-center justify-center rounded-md web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2 web:ring-offset-background web:transition-colors",
  {
    variants: {
      variant: {
